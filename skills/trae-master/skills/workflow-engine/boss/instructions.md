...
→ Leader dispatches needed specialist(s) → Specialist completes
→ Leader dispatches next needed specialist(s) based on dependency and requirement coverage
